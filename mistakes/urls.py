...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name='forgot_password.html'),
         name="reset_password"),
    path('reset_password_sent/', auth_views.PasswordResetDoneView.as_view(template_name='reset_password_email_sent.html'),
         name='password_reset_done'),
    # userid base 64, expiration, for that one user, etc, a lot is in here
